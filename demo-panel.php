	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="#"><button type="button" class="btn btn-success" disabled><i class="fa fa-lock"></i>Submit Assignment</button></a></li>
										...
										<tbody>
											<?php
													while($libraryC = mysqli_fetch_array($libraryC_sql,MYSQLI_ASSOC))
												{
													...
													<td><a href="#"><img src="assets/img/lock.png" /></a><td>
													</tr>';
						...
						<div class="col-lg-6" id="project">
							...
							<div class="panel-body">
								<?php 
									...
									<b>Repository Availble on: </b><a href="#"><img src="assets/img/lock.png" /></a>';
						...
						<div class="col-lg-6" id="progress">
							...
							<div class="panel-body">
								<ul class="list-unstyled task-list">
									...
									<button type="button" class="btn btn-danger btn-lg" onclick="exportTableToExcel('tblData')" disabled><i class="fa fa-download"></i> &nbsp;Download Report</button></br></br>
							</div>
							</div>
						</div>
						...
						<div class="col-lg-12" id="feedback">
							<div class="panel">
								...
								<form class="feedbackForm" action="contactform.php" method="post">
									...
									<button type="submit" class="btn btn-success" disabled><i class="fa fa-paper-plane"></i> &nbsp;Post</button>
								</form>
								</div>
							</div>
						</div>
